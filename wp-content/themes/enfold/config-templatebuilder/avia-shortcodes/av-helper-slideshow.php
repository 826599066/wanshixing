		...
		protected function default_slide()
		{
			...
			foreach($this->id_array as $id)
			{
				if(isset($this->slides[$id]))
				{
					...
					$html .= "<".$tags[0]." >{$caption}<img src='".$img[0]."' width='".$img[1]."' height='".$img[2]."'  alt='".$imgalt."' $markup_url  /></ ".$tags[1]." >";
					$html .= "</li>";
				}
				else
				{
		...
		protected function advanced_slide()
		{
			...
			foreach($this->id_array as $key => $id)
			{
				...
				//title='".$linktitle."'
						...
						$html .= "<img src='".$img[0]."' width='".$img[1]."' height='".$img[2]."'  alt='".$linkalt."' $markup_url $img_style />";
					}
					$html .= $video;
