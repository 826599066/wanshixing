...
if(!function_exists('avia_logo'))
{
	...
	function avia_logo($use_image = "", $sub = "", $headline_type = "h1", $dimension = "")
	{
		...
		$logo_image1_id = wpjam_get_attachment_id(avia_get_option('logo_image1'));
		$logo_image2_id = wpjam_get_attachment_id(avia_get_option('logo_image2'));
		$logo_text_shortcode = "[av_slideshow size='featured' animation='slide' autoplay='true' interval='3' control_layout='av-control-hidden']";
		$logo_text_shortcode .= "[av_slide slide_type='image' id='".$logo_image1_id."' video='' mobile_image='' video_ratio='' title='' link_apply='image' link='manually,".home_url()."' link_target='' video_controls='' video_mute='' video_loop='' video_autoplay=''][/av_slide]";
		$logo_text_shortcode .= "[av_slide slide_type='image' id='".$logo_image2_id."' video='' mobile_image='' video_ratio='' title='' link_apply='image' link='manually,".home_url()."' link_target= '' video_controls='' video_mute='' video_loop='' video_autoplay=''][/av_slide]";
		$logo_text_shortcode .= "[/av_slideshow]";
		$logo_text_html = do_shortcode($logo_text_shortcode);
		$logo_text_wrap = '<div class="logo_text">'.$logo_text_html.'</div>';

		if($logo = avia_get_option('logo'))
		{	


			//$logo .= '<img src="'.avia_get_option('logo_image1').'"><img src="'.avia_get_option('logo_image2').'"></div>';
			 ...
			 $logo = "<$headline_type class='logo'><a href='".$link."'>$logo$sub</a>$logo_text_wrap</$headline_type>";
		}
		else
		{
