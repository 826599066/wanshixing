...
function plyr_filter( $atts ) {
    ...
    $str = sprintf("<video poster='%s' controls data-plyr='{\"showPosterOnEnd\":true,\"controls\":[\"play\", \"progress\", \"current-time\", \"mute\", \"volume\", \"captions\", \"fullscreen\"]}'><source src='%s' type='video/mp4'></video><script>plyr.setup({\"resetOnEnd\":true});</script>",$atts['poster'],$atts['url']);
